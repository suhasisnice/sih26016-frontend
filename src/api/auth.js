...
/* Face biometrics. Enrollment and status are authenticated — something you
   do to your own already-signed-in account — while face-login is not, for
   the same reason /auth/login isn't: the whole point is to establish a
   session, not use one. */
